...
<body>
    <div style="background-color: #f1f5f9; border-radius: 2px; padding-left: 2em; padding-right: 2em;">
        ...
        <div style=" margin-bottom: 2rem; color: #9ca3af;">Click button below to reset your password.</div>
        ...
        <div style="text-align: center; margin-top: 1em; margin-bottom: 4em;">
            <p style="color: #f7fa5a;">Link will expired in 1 days</p>
        </div>
