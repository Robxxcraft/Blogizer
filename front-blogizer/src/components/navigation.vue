<template>
    <nav class="shadow-sm w-full fixed z-20">
        <div class="relative flex flex-col oh lg:flex-row primary items-between justify-center lg:items-center lg:justify-between absolute bg-green-500 px-2 md:px-8 lg:px-14 w-full">
            <div class="ml-2 flex items-center lg:mt-0 justify-between lg:justify-none text-white">
                ...
                <div class="lg:hidden mr-2 text-white hover:text-green-100" @click="openNav">
                ...
                <div class="tabs rounded-b px-2 lg:px-0 top-10 left-0 transform lg:transform-none -translate-y-full bg-green-500 flex flex-col lg:flex-row justify-between w-full lg:py-1.5">
                    <div class="lg:ml-12 mt-4 mb-8 lg:my-0 flex flex-col lg:flex-row uppercase lg:space-x-2 items-start lg:items-center space-y-3 lg:space-y-0">
                        <router-link to="/" class="hover:text-green-100 flex items-end text-white p-2 rounded-lg">
                            <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 9v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9" /><path d="M9 22V12h6v10M2 10.6L12 2l10 8.6" /></svg>
                            <div class="text-xs md:text-sm font-bold tracking-wide">Home</div>
                        </router-link>
                        <router-link to="/popular" class="hover:text-green-100 flex items-end text-white p-2 rounded-lg">
                            <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                            <div class="text-xs md:text-sm font-bold tracking-wide">Popular</div>
                        </router-link>
                        <router-link to="/posts" class="hover:text-green-100 flex items-end text-white p-2 rounded-lg">
                            <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                            <div class="text-xs md:text-sm font-bold tracking-wide">Recent</div>
                        </router-link>
                        <router-link to="/profile" class="hover:text-green-100 flex items-end text-white p-2 rounded-lg">
                            <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path fill="none" d="M0 0h24v24H0z"/><path d="M20 22h-2v-2a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v2H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12zm0-2a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/></svg>
                    ...
                    <div class="mx-2 lg:relative lg:flex">
                                ...
                                <template v-if="auth">
                                    <div class="ml-auto">
                                        <router-link to="/posts/add" title="Add post">
                                            <div class="rounded-full cursor-pointer flex items-center bg-white text-green-500 shadow-sm p-2 text-sm hover:text-white hover:bg-green-500 transition duration-300 font-bold uppercase">
                            ...
                            <template v-if="auth">
                                <div class="select-none">
                                    ...
                                    <div class="block lg:hidden mt-2 mb-4 flex justify-between items-end">
                                        ...
                                        <div class="flex flex-col">
                                            <template v-if="auth.role == 'Admin'">
                                                <div class="text-gray-700 mb-3 shadow-sm w-24 hover:text-green-500 cursor-pointer">
                                    ...
                                    <div class="authDrop hidden absolute w-32 lg:top-12 right-0 bg-white shadow-sm border border-gray-300 rounded p-4">
                                        ...
                                        <template v-if="auth.role == 'Admin'">
                                            <div class="mb-3 text-gray-700 hover:text-gray-800 cursor-pointer">
                                                <a href="/admin/dashboard" class="text-sm flex items-end tracking-wide font-bold">
                            ...
                            <template v-else>
                                <router-link to="/login" class="flex items-center bg-white text-green-500 mb-2 lg:mb-0 w-24 shadow-sm rounded px-2 py-1.5 text-sm hover:text-white hover:bg-green-500 transition font-bold uppercase tracking-wide">
        ...
        <div class="fixed h-screen w-screen z-30 flex justify-center items-center">
            <div class="toast max-w-xs md:max-w-sm w-full bg-red-500 rounded shadow-md p-3">
                <div class="text-sm md:text-base flex justify-between mb-12">
                    ...
                    <div class="cursor-pointer" @click="openToast">
                ...
                <div class="text-xs md:text-sm flex justify-end">
                    <button @click="logout" class="px-4 py-2 text-red-500 bg-white hover:bg-red-500 hover:text-white focus:outline-none rounded font-bold uppercase shadow-sm">logout</button>
                </div>
            </div>
        </div>
    </template>
...
export default {
    setup() {
        ...
        return { openNav, auth, openAD, openToast, logout, logToast, search, searching }
    },
}
</script>
