...
<template>
    <Navigation />
    <main class="py-20 md:py-24 bg-gray-100 px-4 md:px-10 lg:px-16">
        <div class="flex flex-wrap lg:flex-nowrap gap-6">
            <!-- Left Sidebar  -->
            <div class="right-sidebar lg:basis-1/4 md:grid md:grid-cols-2 lg:block gap-4 order-2 lg:order-1">
            ...
            <!-- Main Content -->
            <div class="lg:basis-2/4 order-1 lg:order-2">
                <template v-if="banners.length > 0">
                    <swiper class="shadow" :autoplay="{ delay: 3000, disableOnInteraction: false }" :pagination="true" :slides-per-view="1" :space-between="25">
            ...
            <!-- Right Sidebar -->
                <div class="lg:basis-1/4 w-full order-3">
                    <Categories />
                    <Tags />
                </div>
        </div>
