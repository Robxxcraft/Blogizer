...
<template>
    <div class="overflow-hidden">
        <Navigation />
        <div class="toast mr-2 translate-x-80 overflow-hidden z-30 fixed right-0 top-12 transform transition duration-500 bg-white rounded border-l-8 w-60 lg:w-72 shadow-md border-emerald-500 p-4">
