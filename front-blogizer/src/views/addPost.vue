          ...
          <div class="flex flex-col lg:flex-row justify-between gap-8">
            ...
            <div>
              ...
              <div class="relative select-none">
                <div id="category" @click="openCategoryDrop" class="bg-gray-100 flex justify-between items-center pl-4 rounded w-full border-2 hover:border-green-400 text-gray-400 shadow-sm cursor-pointer">
                ...
                <div id="categoryDropdown" class="absolute top-16 bg-gray-200 w-full h-36 shadow-sm  rounded-sm hidden overflow-y-scroll">
        ...
        <div class="relative">
          ...
          <template v-if="form.tags.length < 5">
            ...
            <div class="absolute top-32 flex items-center gap-2 flex-wrap">
              <div v-for="(tag, index) in form.tags" :key="index" class="bg-green-400 shadow py-2 px-4 rounded-sm text-xs shadow-md flex items-center justify-between">
                <div class="text-white pr-8">{{tag}}</div>
                <svg class="text-white cursor-pointer" @click.prevent="deleteTag(index)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636z"/></svg>
              </div>
            </div>
        </div>
...
export default {
  ...
  setup() {
    ...
    const chooseCategory = (data) => {
      ...
      category.classList.add('text-green-500')
    ...
    return { changeForm, addPost, errors, prevImg, prevData, form, addTag, deleteTag, openCategoryDrop, chooseCategory, categories, loading }
  },
}
</script>
<style>
