    ...
    <section class="p-4 md:p-8 md:mt-0">
      <form @submit.prevent="changeBanner">
          ...
          <div>
            ...
            <div class="rounded-t-lg overflow-hidden">
              <template v-if="prevData.banner1">
                <img :src="prevData.banner1" class="w-full h-48 shadow-sm" alt="banner">
              </template>
              <template v-else>
                <div class="bg-gray-300 w-full h-48 rounded flex items-center justify-center">
            ...
            <div class="mx-auto custom-inp overflow-hidden relative cursor-pointer bg-green-400 hover:bg-green-500 px-2 md:px-4 py-2 text-white text-xs md:text-sm uppercase font-bold tracking-wide rounded-b-lg">
          ...
          <div>
            ...
            <div class="rounded-t-lg overflow-hidden">
              <template v-if="prevData.banner2">
                <img :src="prevData.banner2" class="w-full h-48 shadow-sm" alt="banner">
              </template>
              <template v-else>
                <div class="bg-gray-300 w-full h-48 rounded flex items-center justify-center">
                  <svg class="w-12 h-12 text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path fill="none" d="M0 0h24v24H0z"/><path d="M16 21l-4.762-8.73L15 6l8 15h-7zM8 10l6 11H2l6-11zM5.5 8a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z"/></svg>
          ...
          <div>
            ...
            <div class="rounded-t-lg overflow-hidden">
              <template v-if="prevData.banner3">
                <img :src="prevData.banner3" class="w-full h-48 shadow-sm" alt="banner">
              </template>
              <template v-else>
                <div class="bg-gray-300 w-full h-48 rounded flex items-center justify-center">
                  <svg class="w-12 h-12 text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path fill="none" d="M0 0h24v24H0z"/><path d="M16 21l-4.762-8.73L15 6l8 15h-7zM8 10l6 11H2l6-11zM5.5 8a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z"/></svg>
        ...
        <div class="flex justify-end mt-8">
          <button type="submit" class="focus:outline-none bg-green-500 hover:bg-green-600 shadow-sm text-white font-bold text-sm px-4 py-2 uppercase rounded">
            Save
          </button>
        </div>
      </form>
