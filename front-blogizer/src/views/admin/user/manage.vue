            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                <template v-if="!sloading">
                  <tr class="row" v-for="(user, index) in users" :key="index">
                    <td class="p-3 text-emerald-500 hover:text-green-600 font-bold whitespace-nowrap">{{user.id}}</td>
                    ...
                    <td class="p-3 text-gray-700 whitespace-nowrap">
                      <div class="bg-green-100 border border-emerald-500 text-emerald-500 font-bold text-sm rounded-full shadow-sm px-3 py-1 text-center inline-block">{{user.posts}}</div>
                    </td>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:hidden gap-4">
          <div class="bg-white p-4 rounded-lg shadow-sm" v-for="(user, index) in users" :key="index">
            <div class="flex items-center justify-between mb-2">
              <div class="flex items-center">
                <a href="#" class="text-emerald-500 mr-2 font-bold hover:underline">{{user.id}}</a>
            ...
            <div class="ml-6">
              ...
              <div class="flex items-center justify-between">
                <div class="bg-emerald-500 text-white px-3 py-2 rounded-lg font-bold tracking-wide text-sm inline-block">
                  {{user.role}}
                </div>
