<template>
    ...
    <main class="bg-white max-w-lg mx-auto px-8 py-auto md:rounded md:shadow-2xl h-screen md:h-full relative">
        <div v-if="alert.registered" class="absolute inset-x-0 w-full text-sm bg-green-100 border-b border-green-400 text-green-800 px-3 py-1.5 rounded-md shadow-sm" role="alert">
        ...
        <div v-if="alert.verificated" class="absolute inset-x-0 w-full text-sm bg-green-100 border-b border-green-400 text-green-800 px-3 py-1.5 rounded-md shadow-sm" role="alert">
                <div class="flex justify-between">
                    <div class="flex flex-row items-center">
                        <div class="py-1 mr-4"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="square" stroke-linejoin="arcs"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
        ...
        <section class="pt-8">
            ...
            <p class="text-gray-500 pt-4 text-center">Reset your password.</p>
        </section>
        <section class="mt-10">
            <form @submit.prevent="login">
                ...
                <div>
                    ...
                    <input type="password" v-model="form.email" class="bg-gray-100 py-2 mb-2 rounded w-full text-gray-700 focus:outline-none border-2 focus:border-green-300 transition duration-300 px-3 pb-3" />
                ...
                <div>
                    ...
                    <input type="password" v-model="form.password" class="bg-gray-100 py-2 mb-2 rounded w-full text-gray-700 focus:outline-none border-2 focus:border-green-300 transition duration-300 px-3 pb-3" />
                ...
                <div class="flex flex-col items-end mt-4">
                    ...
                    <button class="bg-green-500 hover:bg-green-600 text-white font-bold px-3 py-2 focus:outline-none rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Login</button>
                </div>
            </form>
        </section>
    ...
    setup() {
        ...
        onMounted(() => {
            if (route.query.registered) {
                ...
                alert.value.registered = "Your account verificated."
            }
        })
        ...
        return { form, login, errors, alert, emailVerif }
    },
}
</script>
<style scoped>
