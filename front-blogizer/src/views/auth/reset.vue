        ...
        <section class="mt-10">
            <form @submit.prevent="login">
                ...
                <div class="flex flex-col items-end mt-4">
                    ...
                    <button class="bg-emerald-500 hover:bg-green-600 text-white font-bold px-3 py-2 focus:outline-none rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Login</button>
                </div>
            </form>
        </section>
